...
def run_tshark():
    # Command to open a new terminal and run tshark
    command = ["gnome-terminal", "--", "tshark", "-i", "eth0"]

    try:
        # Run the command to open a new terminal
...
def main():
    ...
    if opt.iip:
    	BANNER2 = """\b\033[1m
\t  ___ ____              _  __  __                                    _                         
\t |_ _|  _ \   ___ _ __ (_)/ _|/ _| ___ _ __   _ __ _   _ _ __  _ __ (_)_ __   __ _             
\t  | || |_) | / __| '_ \| | |_| |_ / _ \ '__| | '__| | | | '_ \| '_ \| | '_ \ / _` |            
\t  | ||  __/  \__ \ | | | |  _|  _|  __/ |    | |  | |_| | | | | | | | | | | | (_| |  _   _   _ 
\t |___|_|     |___/_| |_|_|_| |_|  \___|_|    |_|   \__,_|_| |_|_| |_|_|_| |_|\__, | (_) (_) (_)
\t                                                                             |___/                
                                                                                      
\033[0m"""
    	print(BANNER2)
    	# Call the function to run tshark
    	run_tshark()
