...
class WhatWafParser(ArgumentParser):
    ...
    @staticmethod
    def cmd_parser():
        parser = ArgumentParser(prog="securewall", add_help=True, usage=(
            "./securewall -[u|l|b|g] VALUE|PATH|PATH|PATH [-p|--pl] PAYLOAD,..|PATH [--args]"
        ))
        ...
        misc.add_argument("-iip", dest="iip", action="store_true", help="Run tshark with iip option")
